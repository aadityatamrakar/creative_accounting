 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/clients/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Client.transactions.findById() instead.
            "prototype$__findById__transactions": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/clients/:id/transactions/:fk",
              method: "GET",
            },

            // INTERNAL. Use Client.transactions.destroyById() instead.
            ...
            // INTERNAL. Use Client.transactions.updateById() instead.
            ...
            // INTERNAL. Use Client.transactions() instead.
            "prototype$__get__transactions": {
              isArray: true,
              url: urlBase + "/clients/:id/transactions",
              method: "GET",
            },

            // INTERNAL. Use Client.transactions.create() instead.
            "prototype$__create__transactions": {
              url: urlBase + "/clients/:id/transactions",
              method: "POST",
            },

            // INTERNAL. Use Client.transactions.destroyAll() instead.
            "prototype$__delete__transactions": {
              url: urlBase + "/clients/:id/transactions",
              method: "DELETE",
            },

            // INTERNAL. Use Client.transactions.count() instead.
            "prototype$__count__transactions": {
              url: urlBase + "/clients/:id/transactions/count",
              method: "GET",
            },
            ...
            // INTERNAL. Use Transaction.client() instead.
            "::get::Transaction::client": {
              url: urlBase + "/transactions/:id/client",
              method: "GET",
            },

            // INTERNAL. Use Slot.client() instead.
            "::get::Slot::client": {
              url: urlBase + "/slots/:id/client",
              method: "GET",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.Client.transactions
     * @header lbServices.Client.transactions
     * @object
     * @description
     *
     * The object `Client.transactions` groups methods
     * manipulating `Transaction` instances related to `Client`.
     *
     * Call {@link lbServices.Client#transactions Client.transactions()}
     ...
     */
             ...
             * @description
             *
             * Queries transactions of client.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - client id
        ...
        R.transactions = function() {
          ...
          var action = TargetResource["::get::Client::transactions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.transactions#count
             * @methodOf lbServices.Client.transactions
             *
             * @description
             *
             * Counts transactions of client.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - client id
        ...
        R.transactions.count = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::count::Client::transactions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.transactions#create
             * @methodOf lbServices.Client.transactions
             *
             * @description
             *
        ...
        R.transactions.create = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::create::Client::transactions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.transactions#createMany
             * @methodOf lbServices.Client.transactions
             *
             * @description
             *
        ...
        R.transactions.createMany = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::createMany::Client::transactions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.transactions#destroyAll
             * @methodOf lbServices.Client.transactions
             *
             * @description
             *
        ...
        R.transactions.destroyAll = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::delete::Client::transactions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.transactions#destroyById
             * @methodOf lbServices.Client.transactions
             *
             * @description
             *
        ...
        R.transactions.destroyById = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::destroyById::Client::transactions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.transactions#findById
             * @methodOf lbServices.Client.transactions
             *
             * @description
             *
        ...
        R.transactions.findById = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::findById::Client::transactions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.transactions#updateById
             * @methodOf lbServices.Client.transactions
             *
             * @description
             *
        ...
        R.transactions.updateById = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::updateById::Client::transactions"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/notifies/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Notify#prototype$patchAttributes
             * @methodOf lbServices.Notify
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Notify#createChangeStream
             * @methodOf lbServices.Notify
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/notifies/change-stream",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Notify#sendMessage
             * @methodOf lbServices.Notify
             *
             * @description
             *
             ...
             */
            "sendMessage": {
              url: urlBase + "/notifies/sendMessage",
              method: "POST",
            },
          }
        );
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Notify#prototype$updateAttributes
             * @methodOf lbServices.Notify
             *
             * @description
             *
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/transactions/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Transaction#report
             * @methodOf lbServices.Transaction
             *
             * @description
             *
             ...
             */
            "report": {
              url: urlBase + "/transactions/report",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Transaction#dashboard
             * @methodOf lbServices.Transaction
             *
             * @description
             *
            ...
            "dashboard": {
              isArray: true,
              url: urlBase + "/transactions/dashboard",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Transaction#sendmsg
             * @methodOf lbServices.Transaction
             *
             * @description
             *
            ...
            "sendmsg": {
              isArray: true,
              url: urlBase + "/transactions/sendmsg",
              method: "GET",
            },

            // INTERNAL. Use Client.transactions.findById() instead.
            "::findById::Client::transactions": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/clients/:id/transactions/:fk",
            ...
            // INTERNAL. Use Client.transactions.destroyById() instead.
            "::destroyById::Client::transactions": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/clients/:id/transactions/:fk",
            ...
            // INTERNAL. Use Client.transactions.updateById() instead.
            "::updateById::Client::transactions": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/clients/:id/transactions/:fk",
            ...
            // INTERNAL. Use Client.transactions.createMany() instead.
            "::createMany::Client::transactions": {
              isArray: true,
              url: urlBase + "/clients/:id/transactions",
              method: "POST",
            },
        ...
        */
        R.modelName = "Transaction";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Transaction#client
             * @methodOf lbServices.Transaction
             *
             * @description
             *
        ...
        R.client = function() {
          ...
          var action = TargetResource["::get::Transaction::client"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/slots/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Slot#prototype$patchAttributes
             * @methodOf lbServices.Slot
             *
             * @description
             *
        ...
        */
        ...
        R.client = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::get::Slot::client"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Counters
 * @header lbServices.Counters
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Counters` model.
 *
 * ## Example
 *
 * See
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/counters/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#create
             * @methodOf lbServices.Counters
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Counters` object.)
             * </em>
             */
            "create": {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#createMany
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#patchOrCreate
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#replaceOrCreate
             * @methodOf lbServices.Counters
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/counters/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Counters#upsertWithWhere
             * @methodOf lbServices.Counters
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/counters/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Counters#exists
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#findById
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#replaceById
             * @methodOf lbServices.Counters
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/counters/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Counters#find
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#findOne
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#updateAll
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#deleteById
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#count
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#prototype$patchAttributes
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#createChangeStream
             * @methodOf lbServices.Counters
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#upsert
             * @methodOf lbServices.Counters
             *
             * @description
             *
        ...
        R["upsert"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#updateOrCreate
             * @methodOf lbServices.Counters
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#patchOrCreateWithWhere
             * @methodOf lbServices.Counters
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#update
             * @methodOf lbServices.Counters
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#destroyById
             * @methodOf lbServices.Counters
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#removeById
             * @methodOf lbServices.Counters
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Counters#prototype$updateAttributes
             * @methodOf lbServices.Counters
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Counters#modelName
        * @propertyOf lbServices.Counters
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Counters`.
        */
